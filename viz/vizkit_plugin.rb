...
Vizkit::UiLoader.register_3d_plugin_for('CorridorPlanVisualization', "/corridors/Plan_m", :update)
...
Vizkit::UiLoader.register_default_widget_for("CorridorPlanView","/corridors/Plan", :update)
